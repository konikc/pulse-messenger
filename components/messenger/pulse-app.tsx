...
import {
  Archive, Bell, ChevronLeft, Ellipsis, FileText, Headphones,
...
type Message = { id: string; senderId: string; body: string | null; kind: string; createdAt: string; encryptedPayload?: { name?: string; type?: string; size?: number } | null }
